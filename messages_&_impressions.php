...
<head>
    ...
    <title>Kak Piyak - Messages & Impressions</title>
...
<body class="bg-gradient-to-r from-indigo-500 to-sky-500 font-sans antialiased"
    ...
    <main class="container mx-auto py-8">
        <section class="section-border mb-8">
            <h2 class="text-xl font-semibold section-title">Messages</h2>
            <p>
                My journey with Kak Piyak began on July 23, 2024, when we first met at New Beverly Hills (NBH) in
                Jababeka. Initially, I was filled with nerves, but those feelings quickly faded as Kak Piyak's warm
                presence made me feel at home. Our conversation flowed easily, and I knew this was the start of a
                meaningful connection.
            </p>
            <p>
                On July 25, 2024, Kak Piyak reached out with a WhatsApp message, followed by a glimpse into their daily
                life through a photo of their university activity. This small gesture showed me Kak Piyak’s willingness
                to share their world with me, strengthening our bond. Even though we almost met up near their campus,
                our virtual conversations continued to be a source of comfort and joy.
            </p>
            <p>
                Playing MLBB together on July 29, 2024, was a delightful experience that highlighted our shared
                interests and camaraderie. When I asked Kak Piyak how much they cared for me, their response of '7' was
                a testament to the newness of our friendship but also a sign of their growing affection. Kak Piyak’s
                openness about their fears and past experiences made me appreciate their trust and the connection we
                were building even more.
            </p>
        </section>

        <section class="section-border">
            <h2 class="text-xl font-semibold section-title">Impressions</h2>
            <p>
                From the very first meeting, Kak Piyak impressed me with their sincerity and genuine nature. Our initial
                nervousness was soon replaced by an easy and comfortable rapport, showing me how special this connection
                could become. Kak Piyak’s ability to be open and share personal aspects of their life has made our
                interactions deeply meaningful.
            </p>
            <p>
                The joy of playing MLBB together and the heartfelt conversations we've had have solidified my admiration
                for Kak Piyak. Their courage to discuss personal fears and their trust in me have been incredibly
                impactful. Every interaction with Kak Piyak has left a lasting impression, making me value our
                friendship even more.
            </p>
            <p>
                Looking ahead, I am excited to continue this journey with Kak Piyak. The messages we’ve exchanged and
                the impressions I’ve gathered are treasured parts of our growing relationship. Our friendship is
                something I hold dear and look forward to nurturing further.
            </p>
        </section>
    </main>
                    ...
                    <ul class="flex space-x-4">
                        ...
                        <li>
                            <a href="https://discordapp.com/users/1187744434264231957"
                                class="text-gray-300 hover:text-white transition">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" x="0px" y="0px" width="100"
