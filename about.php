...
<body class="bg-gradient-to-r from-indigo-500 to-sky-500 font-sans antialiased" style="background-image: url('img/kuromi.jpg');">
    ...
    <header class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white shadow-lg">
        <div class="container mx-auto py-8 flex items-center">
            ...
            <nav class="flex-1 flex justify-center">
                <ul id="menu" class="hidden md:flex space-x-10 items-center">
                    ...
                    <li><a href="messages_&_impressions.html" class="hover:text-yellow-200 font-sans">Messages & Impressions</a></li>
                </ul>
            </nav>
        ...
        <!-- Mobile Menu -->
        <div id="mobile-menu" class="hidden md:hidden bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white">
    ...
    <main class="container mx-auto p-6">
        <div class="flex flex-col items-center md:flex-row">
            ...
            <div class="w-full md:w-1/3 mb-6 md:mb-0">
                <img src="img/logo.png" alt="Gambar Kak Piyak" class="w-full h-auto rounded-lg shadow-lg">
            </div>

            <!-- Penjelasan About Kak Piyak -->
            <div class="w-full md:w-2/3 md:pl-6 border border-gray-300 bg-white p-6 rounded-lg shadow-md">
                <h1 class="text-3xl font-bold mb-4">About Kak Piyak</h1>
                <p class="text-lg mb-4">
                    Kak Piyak and I met for the first time on July 23, 2024, at New Beverly Hills in Jababeka, Cikarang Utara. Despite my initial nervousness, meeting Kak Piyak quickly eased my worries. 
                    Our journey together began with a virtual connection on Discord, where I discovered Kak Piyak's multiple accounts and began to understand their world better.
                </p>
                <p class="text-lg mb-4">
                    On July 25, 2024, Kak Piyak reached out via WhatsApp, sharing a glimpse of their university life. We almost had the chance to meet near their campus, strengthening our bond. Our first shared experience playing MLBB on July 29, 2024, was a memorable one, as we had a great time together. During this time, I asked Kak Piyak how much they cared for me, and their response of '7' reflected the depth of our budding connection, considering we've known each other for only a few weeks.
                </p>
                <p class="text-lg mb-4">
                    Kak Piyak has also shared their personal struggles, including their trauma and fear of men. Through our conversations and interactions, I've strived to offer comfort and support, helping Kak Piyak feel more at ease and trusting.
                </p>
                <p class="text-lg">
                    Our journey together is just beginning, and I'm excited to see where it leads. Kak Piyak is an inspiring figure whose presence has brought significant positivity into my life. I am grateful for our connection and look forward to many more shared experiences.
                </p>
            </div>
        </div>
    </main>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-300 leading-relaxed">Discover Kak Piyak's journey from our first meeting to our shared experiences. From our initial encounter at New Beverly Hills to our fun gaming sessions and meaningful conversations, learn about the special moments that define our bond.</p>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <ul class="flex space-x-4">
                        <li>
                            <a href="https://www.instagram.com/da.real_lyn/" class="text-gray-300 hover:text-white transition">
                        ...
                        <li>
                            <a href="https://discordapp.com/users/1187744434264231957" class="text-gray-300 hover:text-white transition">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" x="0px" y="0px" width="100" height="100" viewBox="0 0 64 64">
